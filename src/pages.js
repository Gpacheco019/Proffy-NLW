...
const { subjects, weekdays, getSubject, hoursToMinutes } = require('./ultils/format')
...
async function saveClasses(req, res) {
    ...
    const classScheduleValues = req.body.weekday.map((weekday, index) => {
        return {
            weekday: weekday,
            time_from: hoursToMinutes(req.body.time_from[index]),
            time_to: hoursToMinutes(req.body.time_to[index])
        }
    })
